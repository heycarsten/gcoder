...
class FormatsTest < Test::Unit::TestCase
  ...
  context 'Formats.symbol_to_class' do
    should 'throw an argument error unless given a symbol' do
      assert_raise ArgumentError do
        GCoder::Formats.symbol_to_class('boom!')
      end
    end

    should 'throw an error when passed an unknown format symbol' do
      assert_raise GCoder::Errors::UnknownFormatSymbolError do
        GCoder::Formats.symbol_to_class(:uberfail)
      end
    end

    should 'return the appropriate class when passed the proper symbol' do
      assert_equal GCoder::Formats::CAPostalCode,
        GCoder::Formats.symbol_to_class(:ca_postal_code)
    end
  end
  ...
  context 'Formats.auto_instantiate' do
    should 'raise a malformed postal code error if no accepted formats match the input' do
      assert_raise GCoder::Errors::MalformedPostalCodeError do
        GCoder::Formats.auto_instantiate('failtron')
      end
    end

    should 'return the first matching instance' do
      assert_instance_of GCoder::Formats::USZipCode,
        GCoder::Formats.auto_instantiate('20037')
    end
  end
  ...
  context 'Creating an instance of AbstractFormat' do
    should 'throw a not implemented error' do
      assert_raise NotImplementedError do
        GCoder::Formats::AbstractFormat.new('test')
      end
    end
  end
  ...
  context 'Creating an instance of USZipCode' do
    should 'fail with the wrong type' do
      assert_raise ArgumentError do
        GCoder::Formats::USZipCode.new(nil)
      end
      assert_raise ArgumentError do
        GCoder::Formats::USZipCode.new(20037)
      end
    end

    should 'fail with a string of the wrong format' do
      assert_raise GCoder::Errors::MalformedPostalCodeError do
        GCoder::Formats::USZipCode.new('2003')
      end
      assert_raise GCoder::Errors::MalformedPostalCodeError do
        GCoder::Formats::USZipCode.new('20037-8')
      end
      assert_raise GCoder::Errors::MalformedPostalCodeError do
        GCoder::Formats::USZipCode.new('')
      end
      assert_raise GCoder::Errors::MalformedPostalCodeError do
        GCoder::Formats::USZipCode.new('BOOM7-8001')
      end
    end

    should 'work with whitespace present' do
      assert GCoder::Formats::USZipCode.new(' 200 37   ')
    end

    should 'allow ZIP+4 with or without a dash' do
      assert GCoder::Formats::USZipCode.new('20037-8001')
      assert GCoder::Formats::USZipCode.new('20037 8001')
      assert GCoder::Formats::USZipCode.new('200378001')
    end
  end

  context 'An instance of USZipCode for ZIP+4 address' do
    setup do
      @zip = GCoder::Formats::USZipCode.new(' 20037 8001 ')
    end
  ...
  context 'Creating an instance of CAPostalCode' do
    should 'fail with the wrong type' do
      assert_raise ArgumentError do
        GCoder::Formats::CAPostalCode.new(123456)
      end
      assert_raise ArgumentError do
        GCoder::Formats::CAPostalCode.new(nil)
      end
    end

    should 'fail with a string of the wrong format' do
      assert_raise GCoder::Errors::MalformedPostalCodeError do
        GCoder::Formats::CAPostalCode.new('M6R')
      end
      assert_raise GCoder::Errors::MalformedPostalCodeError do
        GCoder::Formats::CAPostalCode.new('')
      end
      assert_raise GCoder::Errors::MalformedPostalCodeError do
        GCoder::Formats::CAPostalCode.new('M6R2G5A1')
      end
      assert_raise GCoder::Errors::MalformedPostalCodeError do
        GCoder::Formats::CAPostalCode.new('M6R205')
      end
    end

    should 'work with whitespace present' do
      assert GCoder::Formats::CAPostalCode.new('   M6R2G5 ')
      assert GCoder::Formats::CAPostalCode.new('   M6R 2G5 ')
    end

    should 'upcase any lowercase characters' do
      assert_equal 'M6R2G5', GCoder::Formats::CAPostalCode.new('m6r2g5').to_s
    end
  end
